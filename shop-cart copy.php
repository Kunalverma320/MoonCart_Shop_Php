                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="product-item-price">
                                                Rs.<?php echo $row['product_discount_price']; ?></td>
                                            <td class="product-item-quantity">
                                                <div class="quantity btn-quantity number style-1 me-3">
                                                    ...
                                                    <input type="text" value="<?php echo isset($row['quantity']) ? $row['quantity'] : 1; ?>" min="1"  id="quantity_val"
                                            ...
                                            <td class="product-item-total">Rs.<span
                                                    class="total-price"><?php echo $row['product_discount_price']; ?></span>
                                            </td>
                                        ...
                                        <?php
											$cnt = $cnt + 1;
											$totalPrice += $row['product_discount_price']; 
