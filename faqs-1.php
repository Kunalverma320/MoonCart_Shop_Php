						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 m-b30 m-sm-b15 wow fadeInUp"
							...
							<div class="faq-content-box style-1 light">
								<div>
									...
									<p>If your order has not yet shipped, you can contact us to change your shipping
										address. If your order has already shipped, we may not be able to change the
										address.</p>
								</div>
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 m-b30 m-sm-b15 wow fadeInUp"
							...
							<div class="faq-content-box style-1 light">
								<div>
									...
									<p>Once your order has shipped, you will receive a tracking number via email. You
										can use this tracking number to track your order on our website or on the
										carrier's website.</p>
								</div>
								<a href="faqs-1.html" class="faq-link">
									<svg width="21" height="21" viewBox="0 0 21 21" fill="none"
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 m-b30 m-sm-b15 wow fadeInUp"
							...
							<div class="faq-content-box style-1 light">
								<div>
									...
									<p>If your order has not yet shipped, you can cancel it by contacting us. If your
										order has already shipped, you will need to follow our return policy.</p>
								</div>
								<a href="faqs-1.html" class="faq-link">
									<svg width="21" height="21" viewBox="0 0 21 21" fill="none"
										xmlns="http://www.w3.org/2000/svg">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 m-b30 m-sm-b15 wow fadeInUp"
							...
							<div class="faq-content-box style-1 light">
								<div>
									...
									<p>Yes, we offer gift wrapping for an additional fee. You can select this option
										during checkout.</p>
								</div>
								<a href="faqs-1.html" class="faq-link">
									<svg width="21" height="21" viewBox="0 0 21 21" fill="none"
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 m-b30 m-sm-b15 wow fadeInUp"
							...
							<div class="faq-content-box style-1 light">
								<div>
									...
									<p>Yes, we offer international shipping to select countries. Please check our
										shipping page for more information.</p>
								</div>
								<a href="faqs-1.html" class="faq-link">
									<svg width="21" height="21" viewBox="0 0 21 21" fill="none"
										xmlns="http://www.w3.org/2000/svg">
						...
						<div class="col-xl-4 col-lg-4 col-md-4 col-sm-6 m-b30 m-sm-b15 wow fadeInUp"
							...
							<div class="faq-content-box style-1 light">
								<div>
									...
									<p>We offer a 30-day return policy for most products. If you are not satisfied with
										your purchase, please contact us for instructions on how to return the item.</p>
								</div>
								<a href="faqs-1.html" class="faq-link">
									<svg width="21" height="21" viewBox="0 0 21 21" fill="none"
										xmlns="http://www.w3.org/2000/svg">
