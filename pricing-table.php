...
<body>
    ...
    <div class="dz-bnr-inr style-1" style="background-image:url(images/background/bg-shape.jpg);">
			...
			<!-- Pricing Table -->
			<section class="dz-pricingtable bg-white">
				<div class="container">
					<div class="row pricingtable-wraper">
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
							<div class="pricingtable-wrapper style-1 bg-light m-b30">
								<div class="pricingtable-inner">
									...
									<div class="pricingtable-price">
										<h2 class="pricingtable-bx">$19<small class="pricingtable-type">/Month</small>
										</h2>
									</div>
									<div class="pricingtable-button">
										<a href="shop-registration.html" class="btn bg-white">Try for free</a>
									</div>
						...
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.2s">
							<div class="pricingtable-wrapper style-1 bg-light m-b30">
								<div class="pricingtable-inner">
									<div class="pricingtable-title">
										<h3 class="title">Popular Plan</h3>
										<p class="text">Lorem Ipsum is simply dummy text of the printing and typesetting
											industry.</p>
									</div>
									<div class="pricingtable-price">
										<h2 class="pricingtable-bx">$39<small class="pricingtable-type">/Month</small>
										</h2>
									</div>
									<div class="pricingtable-button">
										<a href="shop-registration.html" class="btn bg-white">Try for free</a>
						...
						<div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
							<div class="pricingtable-wrapper style-1 bg-light m-b30">
								<div class="pricingtable-inner">
									<div class="pricingtable-title">
										<h3 class="title">Custom Plan</h3>
										<p class="text">Lorem Ipsum is simply dummy text of the printing and typesetting
											industry.</p>
									</div>
									<div class="pricingtable-price">
										<h2 class="pricingtable-bx">$69<small class="pricingtable-type">/Month</small>
										</h2>
									</div>
									<div class="pricingtable-button">
										<a href="shop-registration.html" class="btn bg-white">Try for free</a>
			...
			<section class="get-in-touch">
				...
				<a href="contact-us-1.html" class="btn btn-light wow fadeInUp" data-wow-delay="0.2s">Get In Touch</a>
			</section>
			<!-- Get In Touch End -->
